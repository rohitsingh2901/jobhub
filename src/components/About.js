            ...
            <div class="card mb-3" style={{"maxWidth": "540px"}}>
              <div class="row no-gutters">
                <div class="col-md-4 flex justify-center items-center">
                  <img  src="https://img.freepik.com/free-vector/seminar-concept-illustration_114360-7480.jpg?w=1380&t=st=1688735201~exp=1688735801~hmac=75d8882ec09317b80180554310fc8ce7e4a137bc8bdbe3c43b43c6b89354dc12" alt="img" />
                </div>
                <div class="col-md-8 ">
                  <div class="card-body ">
...
Learn new-age skills on the go with our short-term online trainings
        ...
        <div className="row">
          <div className="col-6">
            <div class="card mb-3" style={{"maxWidth": "540px"}}>
              <div class="row no-gutters">
                <div class="col-md-4 flex justify-center items-center">
                  <img  src="https://img.freepik.com/free-vector/tiny-people-searching-business-opportunities_74855-19928.jpg?w=1380&t=st=1688754391~exp=1688754991~hmac=87a23e08316e60ace9d4735869caae8a0f0f9b7ec3ee825fa4a4dcf26294d08c" alt="img" />
                </div>
                <div class="col-md-8 ">
                  <div class="card-body ">
          ...
          <div class="card mb-3" style={{"maxWidth": "540px"}}>
              <div class="row no-gutters">
                <div class="col-md-4 flex justify-center items-center">
                  <img src="https://img.freepik.com/free-vector/business-mission-concept-illustration_114360-7295.jpg?w=1380&t=st=1688754713~exp=1688755313~hmac=b0f49f2423502d7e55fd0cef132f5166789aaea7b3862d017e40bace4ba62622" alt="img" />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
        ...
        <div className="flex items-center justify-content-center my-24">
        <h4 class="text-4xl font-extrabold">In the &nbsp;</h4>
        <h4 class="text-4xl font-extrabold text-red-600">News</h4>
        </div>

        <OwlCarousel className="flex owl-carousel owl-theme owl1">



            <div class="card mb-3 item" style={{"maxWidth": "540px"}}>
              <div class="row no-gutters">
